...
export default function SettingsPage({ settings, onSave, onAppReset }: SettingsPageProps) {
  ...
  const [activeSection, setActiveSection] = useState<"general" | "security" | "appearance" | "backup" | "maintenance">("general");
              ...
              <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                <nav style={{ width: 220 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <button className={`secondary ${activeSection === 'general' ? 'selected' : ''}`} onClick={() => setActiveSection('general')}>General</button>
                    <button className={`secondary ${activeSection === 'security' ? 'selected' : ''}`} onClick={() => setActiveSection('security')}>Security</button>
                    <button className={`secondary ${activeSection === 'appearance' ? 'selected' : ''}`} onClick={() => setActiveSection('appearance')}>Appearance</button>
                    <button className={`secondary ${activeSection === 'backup' ? 'selected' : ''}`} onClick={() => setActiveSection('backup')}>Backup & Restore</button>
                    <button className={`secondary ${activeSection === 'maintenance' ? 'selected' : ''}`} onClick={() => setActiveSection('maintenance')}>Maintenance</button>
                  </div>
                </nav>
